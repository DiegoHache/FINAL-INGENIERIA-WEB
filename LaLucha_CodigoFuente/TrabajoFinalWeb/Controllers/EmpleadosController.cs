    ...
    public class EmpleadosController : Controller
    {
        ...
        public ActionResult Login([Bind(Include = "ID,Contraseña,IdTipoEmpleado,Nombre,Celular,Correo,Direccion,Sueldo")] Empleado user)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewBag.ErrorMessage = "Contraseña incorrecta ¡Vuelve a Ingresar!";
                }
        ...
        public void enviarEMail(string correo,string password)
        {
            ...
            Correo.From = new MailAddress("paparazzinetflix01@gmail.com");
            ...
            ServerEmail.Credentials = new NetworkCredential("paparazzinetflix01@gmail.com", "password12@#");
